...
constexpr auto FW_DRV_RESYN_THR = Field<Register::ISD_CONFIG, 22, 4, unsigned>();
constexpr auto BRK_MODE = Field<Register::ISD_CONFIG, 21, 1, unsigned>();
constexpr auto BRK_CONFIG = Field<Register::ISD_CONFIG, 20, 1, unsigned>();
constexpr auto BRK_CURR_THR = Field<Register::ISD_CONFIG, 17, 3, unsigned>();
constexpr auto BRK_TIME = Field<Register::ISD_CONFIG, 13, 4, unsigned>();
constexpr auto HIZ_TIME = Field<Register::ISD_CONFIG, 9, 4, unsigned>();
constexpr auto STAT_DETECT_THR = Field<Register::ISD_CONFIG, 6, 3, unsigned>();
...
constexpr auto MTR_STARTUP = Field<Register::MOTOR_STARTUP1, 29, 2, unsigned>();
constexpr auto ALIGN_SLOW_RAMP_RATE = Field<Register::MOTOR_STARTUP1, 25, 4, unsigned>();
...
constexpr auto IPD_RLS_MODE = Field<Register::MOTOR_STARTUP1, 8, 1, unsigned>();
constexpr auto IPD_ADV_ANGLE = Field<Register::MOTOR_STARTUP1, 6, 2, unsigned>();
constexpr auto IPD_REPEAT = Field<Register::MOTOR_STARTUP1, 4, 2, unsigned>();
...
constexpr auto OL_ACC_A2 = Field<Register::MOTOR_STARTUP2, 19, 4, unsigned>();
constexpr auto AUTO_HANDOFF_EN = Field<Register::MOTOR_STARTUP2, 18, 1, bool>();
constexpr auto OPN_CL_HANDOFF_THR = Field<Register::MOTOR_STARTUP2, 13, 5, unsigned>();
constexpr auto ALIGN_ANGLE = Field<Register::MOTOR_STARTUP2, 8, 5, unsigned>();
constexpr auto SLOW_FIRST_CYC_FREQ = Field<Register::MOTOR_STARTUP2, 4, 4, unsigned>();
constexpr auto FIRST_CYCLE_FREQ_SEL = Field<Register::MOTOR_STARTUP2, 3, 1, unsigned>();
constexpr auto THETA_ERROR_RAMP_RATE = Field<Register::MOTOR_STARTUP2, 0, 3, unsigned>();
...
constexpr auto PWM_FREQ_OUT = Field<Register::CLOSED_LOOP1, 15, 4, unsigned>();
constexpr auto PWM_MODE = Field<Register::CLOSED_LOOP1, 14, 1, unsigned>();
constexpr auto FG_SEL = Field<Register::CLOSED_LOOP1, 12, 2, unsigned>();
constexpr auto FG_DIV = Field<Register::CLOSED_LOOP1, 8, 4, unsigned>();
constexpr auto FG_CONFIG = Field<Register::CLOSED_LOOP1, 7, 1, unsigned>();
constexpr auto FG_BEMF_THR = Field<Register::CLOSED_LOOP1, 4, 3, unsigned>();
...
// CLOSED_LOOP2
constexpr auto MTR_STOP = Field<Register::CLOSED_LOOP2, 28, 3, unsigned>();
constexpr auto MTR_STOP_BRK_TIME = Field<Register::CLOSED_LOOP2, 24, 4, unsigned>();
constexpr auto ACT_SPIN_THR = Field<Register::CLOSED_LOOP2, 20, 4, unsigned>();
constexpr auto BRAKE_SPEED_THRESHOLD = Field<Register::CLOSED_LOOP2, 16, 4, unsigned>();
...
// REF_PROFILES1
constexpr auto REF_PROFILE_CONFIG = Field<Register::REF_PROFILES1, 29, 2, unsigned>();
...
constexpr auto EEP_FAULT_MODE = Field<Register::FAULT_CONFIG1, 18, 1, unsigned>();
constexpr auto LOCK_ILIMIT_MODE = Field<Register::FAULT_CONFIG1, 15, 3, unsigned>();
constexpr auto LOCK_ILIMIT_DEG = Field<Register::FAULT_CONFIG1, 11, 4, unsigned>();
constexpr auto LCK_RETRY = Field<Register::FAULT_CONFIG1, 7, 4, unsigned>();
constexpr auto CRC_ERR_MODE = Field<Register::FAULT_CONFIG1, 6, 1, unsigned>();
constexpr auto MTR_LCK_MODE = Field<Register::FAULT_CONFIG1, 3, 3, unsigned>();
...
constexpr auto LOCK_ABN_SPEED = Field<Register::FAULT_CONFIG2, 25, 3, unsigned>();
constexpr auto ABNORMAL_BEMF_THR = Field<Register::FAULT_CONFIG2, 22, 3, unsigned>();
constexpr auto NO_MTR_THR = Field<Register::FAULT_CONFIG2, 19, 3, unsigned>();
constexpr auto HW_LOCK_ILIMIT_MODE = Field<Register::FAULT_CONFIG2, 16, 3, unsigned>();
constexpr auto HW_LOCK_ILIMIT_DEG = Field<Register::FAULT_CONFIG2, 13, 3, unsigned>();
constexpr auto VOLTAGE_HYSTERESIS = Field<Register::FAULT_CONFIG2, 11, 2, unsigned>();
constexpr auto MIN_VM_MOTOR = Field<Register::FAULT_CONFIG2, 8, 3, unsigned>();
constexpr auto MIN_VM_MODE = Field<Register::FAULT_CONFIG2, 7, 1, unsigned>();
constexpr auto MAX_VM_MOTOR = Field<Register::FAULT_CONFIG2, 4, 3, unsigned>();
constexpr auto MAX_VM_MODE = Field<Register::FAULT_CONFIG2, 3, 1, unsigned>();
constexpr auto AUTO_RETRY_TIMES = Field<Register::FAULT_CONFIG2, 0, 3, unsigned>();
...
constexpr auto PWM_DITHER_STEP = Field<Register::PIN_CONFIG, 29, 2, unsigned>();
constexpr auto VDC_FILTER = Field<Register::PIN_CONFIG, 27, 2, unsigned>();
...
constexpr auto BRAKE_PIN_MODE = Field<Register::PIN_CONFIG, 5, 1, unsigned>();
...
// DEVICE_CONFIG1
constexpr auto DAC_SOx_SEL = Field<Register::DEVICE_CONFIG1, 28, 2, unsigned>();
constexpr auto PWM_DITHER_MODE = Field<Register::DEVICE_CONFIG1, 27, 1, unsigned>();
...
constexpr auto SLEW_RATE_I2C_PINS = Field<Register::DEVICE_CONFIG1, 3, 2, unsigned>();
constexpr auto PULLUP_ENABLE = Field<Register::DEVICE_CONFIG1, 2, 1, bool>();
constexpr auto BUS_VOLT = Field<Register::DEVICE_CONFIG1, 0, 2, unsigned>();
...
constexpr auto PWM_DITHER_DEPTH = Field<Register::DEVICE_CONFIG2, 9, 2, unsigned>();
...
constexpr auto ABNORMAL_BEMF_PERSISTENT_TIME = Field<Register::PERI_CONFIG1, 26, 2, unsigned>();
constexpr auto FLUX_WEAK_REF = Field<Register::PERI_CONFIG1, 24, 2, unsigned>();
constexpr auto INPUT_REFERENCE_WINDOW = Field<Register::PERI_CONFIG1, 22, 2, unsigned>();
...
constexpr auto DIR_CHANGE_MODE = Field<Register::PERI_CONFIG1, 18, 1, unsigned>();
...
constexpr auto EEPROM_LOCK_MODE = Field<Register::PERI_CONFIG1, 5, 2, unsigned>();
...
// GD_CONFIG1
constexpr auto SLEW_RATE = Field<Register::GD_CONFIG1, 26, 2, unsigned>();
constexpr auto OVP_SEL = Field<Register::GD_CONFIG1, 19, 1, unsigned>();
constexpr auto OVP_EN = Field<Register::GD_CONFIG1, 18, 1, bool>();
constexpr auto OTW_REP = Field<Register::GD_CONFIG1, 16, 1, bool>();
constexpr auto OCP_DEG = Field<Register::GD_CONFIG1, 12, 2, unsigned>();
constexpr auto OCP_LVL = Field<Register::GD_CONFIG1, 10, 1, unsigned>();
constexpr auto OCP_MODE = Field<Register::GD_CONFIG1, 8, 2, unsigned>();
...
constexpr auto BUCK_CL = Field<Register::GD_CONFIG2, 23, 1, unsigned>();
constexpr auto BUCK_SEL = Field<Register::GD_CONFIG2, 21, 2, unsigned>();
constexpr auto BUCK_DIS = Field<Register::GD_CONFIG2, 20, 1, bool>();
constexpr auto MIN_ON_TIME = Field<Register::GD_CONFIG2, 17, 3, unsigned>();
...
constexpr auto SPEED_PIN_GLITCH_FILTER = Field<Register::INT_ALGO1, 27, 2, unsigned>();
constexpr auto FAST_ISD_EN = Field<Register::INT_ALGO1, 26, 1, bool>();
constexpr auto ISD_STOP_TIME = Field<Register::INT_ALGO1, 24, 2, unsigned>();
constexpr auto ISD_RUN_TIME = Field<Register::INT_ALGO1, 22, 2, unsigned>();
constexpr auto ISD_TIMEOUT = Field<Register::INT_ALGO1, 20, 2, unsigned>();
constexpr auto AUTO_HANDOFF_MIN_BEMF = Field<Register::INT_ALGO1, 17, 3, unsigned>();
constexpr auto BRAKE_CURRENT_PERSIST = Field<Register::INT_ALGO1, 15, 2, unsigned>();
