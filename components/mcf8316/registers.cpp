...
bool Config::needs_mpet_for_speed_loop() const {
  return get(MOTOR_RES) == 0 || get(MOTOR_IND) == 0 || get(MOTOR_BEMF_CONST) == 0 || get(SPD_LOOP_KP) == 0 ||
      get(SPD_LOOP_KI) == 0;
}
...
const char *ALGORITHM_STATE_NAMES[] = {
    ...
    "ALIGN",
    "OPEN_LOOP",
    "CLOSED_LOOP_UNALIGNED",
    "CLOSED_LOOP_ALIGNED",
    "CLOSED_LOOP_ACTIVE_BRAKING",
    "SOFT_STOP",
    "RECIRCULATE_STOP",
    "BRAKE_ON_STOP",
    "FAULT",
    "MPET_MOTOR_STOP_CHECK",
    "MPET_MOTOR_STOP_WAIT",
    "MPET_MOTOR_BRAKE",
    "MPET_ALGORITHM_PARAMETERS_INIT",
    "MPET_RL_MEASURE",
    "MPET_KE_MEASURE",
    "MPET_STALL_CURRENT_MEASURE",
    "MPET_TORQUE_MODE",
    "MPET_DONE",
    "MPET_FAULT",
};
...
const char *CONTROLLER_FAULT_BITS[32] = {
    ...
    "MAX_SPEED_SATURATION",
    "BUS_POWER_LIMIT_SATURATION",
    "EEPROM_WRITE_LOCK_SET",
    "EEPROM_READ_LOCK_SET",
    nullptr,
    nullptr,
    nullptr,
    "I2C_CRC_FAULT_STATUS",
    "EEPROM_ERR_STATUS",
    "BOOT_STL_FAULT",
    "WATCHDOG_FAULT",
    "CPU_RESET_FAULT_STATUS",
    "WWDT_FAULT_STATUS",
    nullptr,
};
